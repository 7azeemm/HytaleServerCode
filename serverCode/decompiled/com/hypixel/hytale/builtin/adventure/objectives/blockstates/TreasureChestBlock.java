...
implements Component<ChunkStore> {
    @Nonnull
    public static final BuilderCodec<TreasureChestBlock> CODEC = ((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)BuilderCodec.builder(TreasureChestBlock.class, TreasureChestBlock::new).append(new KeyedCodec<UUID>("ObjectiveUUID", Codec.UUID_BINARY), (treasureChestState, uuid) -> {
