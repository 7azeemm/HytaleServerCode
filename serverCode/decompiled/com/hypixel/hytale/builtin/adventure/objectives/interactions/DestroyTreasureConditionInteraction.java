...
public class DestroyTreasureConditionInteraction
extends SimpleBlockInteraction {
    public static final BuilderCodec<DestroyTreasureConditionInteraction> CODEC = ((BuilderCodec.Builder)BuilderCodec.builder(DestroyTreasureConditionInteraction.class, DestroyTreasureConditionInteraction::new, SimpleBlockInteraction.CODEC).documentation("Checks if the target treasure block is destroyable")).build();
