...
extends ObjectiveTask {
    ...
    @Nullable
    private Ref<ChunkStore> spawnChestBlock(@Nonnull World world, @Nonnull Vector3i conditionPosition, String chestBlockTypeKey, @Nonnull SpawnTreasureChestTransactionRecord transactionRecord) {
        ...
        Ref<ChunkStore> blockEntity = ((WorldChunk)worldChunk).getBlockComponentEntity(conditionPosition.x, conditionPosition.y, conditionPosition.z);
        if (blockEntity == null) {
