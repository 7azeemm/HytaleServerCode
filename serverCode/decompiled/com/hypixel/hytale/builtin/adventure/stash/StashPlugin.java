...
extends JavaPlugin {
    ...
    protected void setup() {
        this.getChunkStoreRegistry().registerSystem(new StashSystem(ItemContainerBlock.getComponentType()));
        this.getCodecRegistry(GameplayConfig.PLUGIN_CODEC).register(StashGameplayConfig.class, "Stash", StashGameplayConfig.CODEC);
    }

    @Nullable
    public static ListTransaction<ItemStackTransaction> stash(BlockModule.BlockStateInfo blockStateInfo, @Nonnull ItemContainerBlock containerState, boolean clearDropList) {
