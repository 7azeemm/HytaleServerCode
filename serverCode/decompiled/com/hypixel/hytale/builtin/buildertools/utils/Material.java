...
public final class Material {
    public static final Material EMPTY = new Material(0, 0, 0, 0, 0, 0, null);
    ...
    public static Material block(int blockId, int rotation) {
        ...
        return new Material(blockId, 0, 0, rotation, 0, 0, null);
    }
    ...
    public static Material fluid(int fluidId, byte fluidLevel) {
        ...
        return new Material(0, fluidId, fluidLevel, 0, 0, 0, null);
    }
    ...
    public static Material full(int blockId, int rotation, int support, int filler, @Nullable Holder<ChunkStore> holder) {
        ...
        return new Material(blockId, 0, 0, rotation, support, filler, holder);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return this.blockId == other.blockId && this.fluidId == other.fluidId && this.fluidLevel == other.fluidLevel && this.rotation == other.rotation && this.support == other.support && this.filler == other.filler && Objects.equals(this.holder, other.holder);
    }

    public int hashCode() {
        int result = 31 * (31 * (31 * this.blockId + this.fluidId) + this.fluidLevel) + this.rotation;
        result = 31 * (31 * (31 * result + this.support) + this.filler) + Objects.hashCode(this.holder);
        return result;
    }
