...
extends JavaPlugin {
    ...
    protected void setup() {
        ...
        this.processingBenchBlockComponentType = this.getChunkStoreRegistry().registerComponent(ProcessingBenchBlock.class, "ProcessingBenchBlock", ProcessingBenchBlock.CODEC);
        this.getChunkStoreRegistry().registerSystem(new MigrateCrafting());
        ...
        this.getChunkStoreRegistry().registerSystem(new BenchSystems.ProcessingBenchLifecycle(this.processingBenchBlockComponentType, this.benchBlockComponentType));
    ...
    public static class MigrateCrafting
