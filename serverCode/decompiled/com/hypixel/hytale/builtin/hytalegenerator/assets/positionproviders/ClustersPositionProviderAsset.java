...
public class ClustersPositionProviderAsset
extends PositionProviderAsset {
    @Nonnull
    public static final BuilderCodec<ClustersPositionProviderAsset> CODEC = ((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)BuilderCodec.builder(ClustersPositionProviderAsset.class, ClustersPositionProviderAsset::new, PositionProviderAsset.ABSTRACT_CODEC).append(new KeyedCodec("Cluster", PositionProviderAsset.CODEC, true), (asset, value) -> {
        asset.clusterPositionProviderAsset = value;
    }, asset -> asset.clusterPositionProviderAsset).add()).append(new KeyedCodec("Distributor", PositionProviderAsset.CODEC, true), (asset, value) -> {
        asset.distributorPositionProviderAsset = value;
    }, asset -> asset.distributorPositionProviderAsset).add()).append(new KeyedCodec("ClusterBounds", DecimalBounds3dAsset.CODEC, true), (asset, v) -> {
        asset.clusterBoundsAsset = v;
    }, asset -> asset.clusterBoundsAsset).add()).build();
    @Nonnull
