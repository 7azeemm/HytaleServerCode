...
extends PositionProviderAsset {
    @Nonnull
    public static final BuilderCodec<Jitter3dPositionProviderAsset> CODEC = ((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)BuilderCodec.builder(Jitter3dPositionProviderAsset.class, Jitter3dPositionProviderAsset::new, PositionProviderAsset.ABSTRACT_CODEC).append(new KeyedCodec<Double>("Magnitude", Codec.DOUBLE, true), (asset, value) -> {
