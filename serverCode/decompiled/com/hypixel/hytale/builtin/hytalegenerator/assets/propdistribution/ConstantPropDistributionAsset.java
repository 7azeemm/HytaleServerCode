...
public class ConstantPropDistributionAsset
extends PropDistributionAsset {
    @Nonnull
    public static final BuilderCodec<ConstantPropDistributionAsset> CODEC = ((BuilderCodec.Builder)((BuilderCodec.Builder)BuilderCodec.builder(ConstantPropDistributionAsset.class, ConstantPropDistributionAsset::new, PropDistributionAsset.ABSTRACT_CODEC).append(new KeyedCodec("Positions", PositionProviderAsset.CODEC, true), (t, k) -> {
        t.positionProviderAsset = k;
    }, k -> k.positionProviderAsset).add()).append(new KeyedCodec("Prop", PropAsset.CODEC, true), (t, k) -> {
        t.propAsset = k;
    }, k -> k.propAsset).add()).build();
