...
public class PositionsPropDistributionAsset
extends PropDistributionAsset {
    @Nonnull
    public static final BuilderCodec<PositionsPropDistributionAsset> CODEC = ((BuilderCodec.Builder)BuilderCodec.builder(PositionsPropDistributionAsset.class, PositionsPropDistributionAsset::new, PropDistributionAsset.ABSTRACT_CODEC).append(new KeyedCodec("Positions", PositionProviderAsset.CODEC, true), (asset, value) -> {
