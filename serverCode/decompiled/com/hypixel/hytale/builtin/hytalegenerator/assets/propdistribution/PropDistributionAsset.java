...
public abstract class PropDistributionAsset
implements Cleanable,
JsonAssetWithMap<String, DefaultAssetMap<String, PropDistributionAsset>> {
    @Nonnull
    public static final AssetCodecMapCodec<String, PropDistributionAsset> CODEC = new AssetCodecMapCodec<String, PropDistributionAsset>(Codec.STRING, (t, k) -> {
        t.id = k;
    }, t -> t.id, (t, data) -> {
        t.data = data;
    }, t -> t.data);
    @Nonnull
    private static final Map<String, PropDistributionAsset> exportedNodes = new ConcurrentHashMap<String, PropDistributionAsset>();
    @Nonnull
    ...
    @Nonnull
    public static final BuilderCodec<PropDistributionAsset> ABSTRACT_CODEC = ((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)BuilderCodec.abstractBuilder(PropDistributionAsset.class).append(new KeyedCodec<Boolean>("Skip", Codec.BOOLEAN, false), (t, k) -> {
        t.skip = k;
        ...
        if (asset.exportName != null && !asset.exportName.isEmpty()) {
            ...
            exportedNodes.put(asset.exportName, (PropDistributionAsset)asset);
    ...
    public abstract PropDistribution build(@Nonnull Argument var1);
