...
JsonAssetWithMap<String, DefaultAssetMap<String, PropRuntimeAsset>> {
    @Nonnull
    public static final AssetBuilderCodec<String, PropRuntimeAsset> CODEC = ((AssetBuilderCodec.Builder)((AssetBuilderCodec.Builder)((AssetBuilderCodec.Builder)((AssetBuilderCodec.Builder)((AssetBuilderCodec.Builder)AssetBuilderCodec.builder(PropRuntimeAsset.class, PropRuntimeAsset::new, Codec.STRING, (asset, id) -> {
        asset.id = id;
    ...
    }, t -> t.assignmentsAsset).add()).append(new KeyedCodec("PropDistribution", PropDistributionAsset.CODEC, true), (t, k) -> {
        t.propDistributionAsset = k;
    }, t -> t.propDistributionAsset).add()).append(new KeyedCodec<Boolean>("Skip", Codec.BOOLEAN, false), (t, k) -> {
        t.skip = k;
    }, t -> t.skip).add()).build();
    private String id;
    ...
    public PositionProvider buildPositionProvider_deprecated(@Nonnull SeedBox parentSeed, @Nonnull ReferenceBundle referenceBundle, @Nonnull WorkerIndexer.Id workerId) {
        return this.positionProviderAsset.build(new PositionProviderAsset.Argument(parentSeed, referenceBundle, workerId));
    }

    public Assignments buildAssignments_deprecated(@Nonnull SeedBox parentSeed, @Nonnull MaterialCache materialCache, @Nonnull ReferenceBundle referenceBundle, @Nonnull WorkerIndexer.Id workerId) {
        return this.assignmentsAsset.build(new AssignmentsAsset.Argument(parentSeed, materialCache, referenceBundle, workerId));
    }

    @Nonnull
    public PropDistribution buildPropDistribution(@Nonnull SeedBox parentSeed, @Nonnull MaterialCache materialCache, int runtime, @Nonnull ReferenceBundle referenceBundle, @Nonnull WorkerIndexer.Id workerId) {
