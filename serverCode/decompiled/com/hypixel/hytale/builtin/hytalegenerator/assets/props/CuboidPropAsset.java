...
public class CuboidPropAsset
extends PropAsset {
    @Nonnull
    public static final BuilderCodec<CuboidPropAsset> CODEC = ((BuilderCodec.Builder)((BuilderCodec.Builder)BuilderCodec.builder(CuboidPropAsset.class, CuboidPropAsset::new, PropAsset.ABSTRACT_CODEC).append(new KeyedCodec("Bounds", IntegerBounds3dAsset.CODEC, true), (asset, value) -> {
        asset.boundsAsset = value;
    }, asset -> asset.boundsAsset).add()).append(new KeyedCodec("Material", MaterialProviderAsset.CODEC, true), (asset, value) -> {
        asset.materialProviderAsset = value;
