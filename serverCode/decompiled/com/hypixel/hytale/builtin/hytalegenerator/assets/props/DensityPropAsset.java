...
import com.hypixel.hytale.builtin.hytalegenerator.props.deprecated.DensityProp;
...
extends PropAsset {
    @Nonnull
    public static final BuilderCodec<DensityPropAsset> CODEC = ((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)BuilderCodec.builder(DensityPropAsset.class, DensityPropAsset::new, PropAsset.ABSTRACT_CODEC).append(new KeyedCodec("Density", DensityAsset.CODEC, true), (asset, v) -> {
    ...
    }, asset -> asset.materialProviderAsset).add()).append(new KeyedCodec("Bounds", IntegerBounds3dAsset.CODEC, true), (asset, v) -> {
        asset.boundsAsset = v;
    }, asset -> asset.boundsAsset).add()).append(new KeyedCodec<Vector3i>("Range", Vector3i.CODEC, true), (asset, v) -> {
        asset.range = v;
    ...
    public Prop build(@Nonnull PropAsset.Argument argument) {
        ...
        if (this.patternAsset != DEFAULT_PATTERN_ASSET || this.scannerAsset != DEFAULT_SCANNER_ASSET || this.range != DEFAULT_RANGE_ASSET || this.placementMaskAsset != DEFAULT_MASK_ASSET) {
        ...
        return new com.hypixel.hytale.builtin.hytalegenerator.props.DensityProp(this.densityAsset.build(DensityAsset.from(argument)), this.materialProviderAsset.build(MaterialProviderAsset.argumentFrom(argument)), this.boundsAsset.build());
    }
