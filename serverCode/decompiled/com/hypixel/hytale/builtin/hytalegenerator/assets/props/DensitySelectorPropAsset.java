...
public class DensitySelectorPropAsset
extends PropAsset {
    @Nonnull
    public static final BuilderCodec<DensitySelectorPropAsset> CODEC = ((BuilderCodec.Builder)((BuilderCodec.Builder)BuilderCodec.builder(DensitySelectorPropAsset.class, DensitySelectorPropAsset::new, PropAsset.ABSTRACT_CODEC).append(new KeyedCodec<T[]>("Delimiters", new ArrayCodec(DelimiterAsset.CODEC, DelimiterAsset[]::new), true), (asset, value) -> {
        asset.delimiterAssets = value;
    }, asset -> asset.delimiterAssets).add()).append(new KeyedCodec("Density", DensityAsset.CODEC, true), (asset, value) -> {
    ...
    public Prop build(@Nonnull PropAsset.Argument argument) {
        ...
        ArrayList<DelimiterDouble<Prop>> delimiters = new ArrayList<DelimiterDouble<Prop>>(this.delimiterAssets.length);
        for (DelimiterAsset delimiterAsset : this.delimiterAssets) {
            ...
            DelimiterDouble<Prop> delimiter = new DelimiterDouble<Prop>(range, prop);
    ...
    JsonAssetWithMap<String, DefaultAssetMap<String, DelimiterAsset>> {
        ...
        public static final AssetBuilderCodec<String, DelimiterAsset> CODEC = ((AssetBuilderCodec.Builder)((AssetBuilderCodec.Builder)AssetBuilderCodec.builder(DelimiterAsset.class, DelimiterAsset::new, Codec.STRING, (asset, id) -> {
            ...
            config.data = data;
        }, config -> config.data).append(new KeyedCodec("Range", RangeDoubleAsset.CODEC, true), (asset, value) -> {
            asset.rangeAsset = value;
        }, asset -> asset.rangeAsset).add()).append(new KeyedCodec("Prop", PropAsset.CODEC, true), (asset, value) -> {
