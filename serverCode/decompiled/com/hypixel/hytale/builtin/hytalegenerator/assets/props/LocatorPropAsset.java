...
public class LocatorPropAsset
extends PropAsset {
    @Nonnull
    public static final BuilderCodec<LocatorPropAsset> CODEC = ((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)BuilderCodec.builder(LocatorPropAsset.class, LocatorPropAsset::new, PropAsset.ABSTRACT_CODEC).append(new KeyedCodec("Prop", PropAsset.CODEC, true), (asset, value) -> {
        asset.propAsset = value;
    }, asset -> asset.propAsset).add()).append(new KeyedCodec("Pattern", PatternAsset.CODEC, true), (asset, value) -> {
    ...
    }, asset -> asset.scannerAsset).add()).append(new KeyedCodec<Integer>("PlacementCap", Codec.INTEGER, true), (asset, value) -> {
        asset.placementCap = value;
    }, asset -> asset.placementCap).addValidator(Validators.greaterThanOrEqual(0)).add()).build();
    @Nonnull
