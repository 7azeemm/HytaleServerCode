...
public class MaskPropAsset
extends PropAsset {
    @Nonnull
    public static final BuilderCodec<MaskPropAsset> CODEC = ((BuilderCodec.Builder)((BuilderCodec.Builder)BuilderCodec.builder(MaskPropAsset.class, MaskPropAsset::new, PropAsset.ABSTRACT_CODEC).append(new KeyedCodec("Prop", PropAsset.CODEC, true), (asset, value) -> {
        asset.propAsset = value;
    }, asset -> asset.propAsset).add()).append(new KeyedCodec("Mask", BlockMaskAsset.CODEC, true), (asset, value) -> {
        asset.blockMaskAsset = value;
    }, asset -> asset.blockMaskAsset).add()).build();
    @Nonnull
