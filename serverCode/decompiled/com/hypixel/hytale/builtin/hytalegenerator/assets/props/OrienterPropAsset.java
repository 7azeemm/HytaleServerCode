...
public class OrienterPropAsset
extends PropAsset {
    @Nonnull
    public static final BuilderCodec<OrienterPropAsset> CODEC = ((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)BuilderCodec.builder(OrienterPropAsset.class, OrienterPropAsset::new, PropAsset.ABSTRACT_CODEC).append(new KeyedCodec("Prop", PropAsset.CODEC, true), (asset, value) -> {
    ...
    }, asset -> asset.rotationAssets).add()).append(new KeyedCodec("Pattern", PatternAsset.CODEC, true), (asset, value) -> {
        asset.patternAsset = value;
    }, asset -> asset.patternAsset).add()).append(new KeyedCodec("Scanner", ScannerAsset.CODEC, true), (asset, value) -> {
        asset.scannerAsset = value;
    }, asset -> asset.scannerAsset).add()).append(new KeyedCodec<OrienterProp.SelectionMode>("SelectionMode", new EnumCodec<OrienterProp.SelectionMode>(OrienterProp.SelectionMode.class), true), (asset, value) -> {
        asset.selectionMode = value;
    }, asset -> asset.selectionMode).add()).append(new KeyedCodec<String>("Seed", Codec.STRING, false), (asset, value) -> {
        asset.seed = value;
    ...
    public Prop build(@Nonnull PropAsset.Argument argument) {
        ...
        ArrayList<RotationTuple> rotations = new ArrayList<RotationTuple>(this.rotationAssets.length);
