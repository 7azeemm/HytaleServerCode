...
import com.hypixel.hytale.builtin.hytalegenerator.props.deprecated.filler.PondFillerProp;
...
extends PropAsset {
    @Nonnull
    public static final BuilderCodec<PondFillerPropAsset> CODEC = ((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)BuilderCodec.builder(PondFillerPropAsset.class, PondFillerPropAsset::new, PropAsset.ABSTRACT_CODEC).append(new KeyedCodec("FillMaterial", MaterialProviderAsset.CODEC, true), (asset, v) -> {
    ...
    }, asset -> asset.solidSetAsset).add()).append(new KeyedCodec("Bounds", IntegerBounds3dAsset.CODEC, true), (asset, v) -> {
        asset.boundsAsset = v;
    }, asset -> asset.boundsAsset).add()).append(new KeyedCodec<Vector3i>("BoundingMin", Vector3i.CODEC, true), (asset, v) -> {
        asset.boundingMin = v;
    }, asset -> asset.boundingMin).add()).append(new KeyedCodec<Vector3i>("BoundingMax", Vector3i.CODEC, true), (asset, v) -> {
        asset.boundingMax = v;
    }, asset -> asset.boundingMax).add()).append(new KeyedCodec("Pattern", PatternAsset.CODEC, true), (asset, v) -> {
    ...
    public Prop build(@Nonnull PropAsset.Argument argument) {
        ...
        if (this.patternAsset != DEFAULT_PATTERN_ASSET || this.scannerAsset != DEFAULT_SCANNER_ASSET || this.boundingMin != DEFAULT_MIN_ASSET || this.boundingMax != DEFAULT_MAX_ASSET) {
        ...
        return new com.hypixel.hytale.builtin.hytalegenerator.props.PondFillerProp(this.boundsAsset.build(), this.fluidMaterialProviderAsset.build(MaterialProviderAsset.argumentFrom(argument)), this.solidSetAsset.build(argument.materialCache));
    }
