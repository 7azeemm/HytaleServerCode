...
public class RadialScannerAsset
extends ScannerAsset {
    @Nonnull
    public static final BuilderCodec<RadialScannerAsset> CODEC = ((BuilderCodec.Builder)((BuilderCodec.Builder)BuilderCodec.builder(RadialScannerAsset.class, RadialScannerAsset::new, ScannerAsset.ABSTRACT_CODEC).append(new KeyedCodec("Bounds", IntegerBounds3dAsset.CODEC, true), (asset, value) -> {
        asset.boundsAsset = value;
    }, asset -> asset.boundsAsset).add()).append(new KeyedCodec("Scanner", ScannerAsset.CODEC, false), (asset, value) -> {
