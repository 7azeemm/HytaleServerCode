...
public class RandomScannerAsset
extends ScannerAsset {
    @Nonnull
    public static final BuilderCodec<RandomScannerAsset> CODEC = ((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)BuilderCodec.builder(RandomScannerAsset.class, RandomScannerAsset::new, ScannerAsset.ABSTRACT_CODEC).append(new KeyedCodec<Axis>("Axis", new EnumCodec<Axis>(Axis.class), true), (asset, value) -> {
        asset.axis = value;
    ...
    }, asset -> asset.scannerAsset).add()).append(new KeyedCodec<String>("Seed", Codec.STRING, true), (asset, value) -> {
        asset.seed = value;
