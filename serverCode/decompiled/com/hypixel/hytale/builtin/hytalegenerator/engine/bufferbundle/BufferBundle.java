...
public class BufferBundle
implements MemInstrument {
    @Nonnull
    private final Map<BufferType, Grid> grids = new HashMap<BufferType, Grid>();

    @Nonnull
    public Grid createGrid(@Nonnull BufferType bufferType, int capacity) {
        assert (capacity >= 0);
    ...
    @Nonnull
    public Access createBufferAccess(@Nonnull BufferType bufferType, @Nonnull Bounds3i bounds_bufferGrid) {
    ...
    @Nonnull
    public Grid getGrid(@Nonnull BufferType contentType) {
    ...
    public MemInstrument.Report getMemoryUsage() {
        long size_bytes = 16L;
        for (Map.Entry<BufferType, Grid> entry : this.grids.entrySet()) {
    ...
    implements MemInstrument {
        ...
        public record TrackedBuffer(@Nonnull Tracker tracker, @Nonnull Buffer buffer) implements MemInstrument
        {
            @Override
            @Nonnull
            public MemInstrument.Report getMemoryUsage() {
    ...
    implements MemInstrument {
        ...
        @Nonnull
        public Grid.TrackedBuffer getBuffer(int x_bufferGrid, int y_bufferGrid, int z_bufferGrid) {
