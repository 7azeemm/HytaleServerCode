...
public class CountedPixelBuffer<T>
extends PixelBuffer<T> {
    ...
    public T getPixelContent(@Nonnull Vector3i position) {
        ...
        return switch (this.state.ordinal()) {
            ...
            case 2 -> this.countedArrayContents.array[CountedPixelBuffer.index(position)];
            default -> null;
        };
    }
    ...
    public void setPixelContent(@Nonnull Vector3i position, @Nullable T value) {
        ...
        switch (this.state.ordinal()) {
            ...
            case 2: {
                this.countedArrayContents.array[CountedPixelBuffer.index((Vector3i)position)] = value;
    ...
    private static int index(@Nonnull Vector3i position) {
        return position.y + position.x * CountedPixelBuffer.SIZE_VOXEL_GRID.y + position.z * CountedPixelBuffer.SIZE_VOXEL_GRID.y * CountedPixelBuffer.SIZE_VOXEL_GRID.x;
    }
    ...
    implements MemInstrument {
        ...
        public CountedArrayContents() {
            this.array = new Object[CountedPixelBuffer.SIZE_VOXEL_GRID.x * CountedPixelBuffer.SIZE_VOXEL_GRID.y * CountedPixelBuffer.SIZE_VOXEL_GRID.z];
