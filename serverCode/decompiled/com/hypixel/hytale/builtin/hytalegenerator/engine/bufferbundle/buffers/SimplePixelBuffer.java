...
public class SimplePixelBuffer<T>
extends PixelBuffer<T> {
    ...
    public T getPixelContent(@Nonnull Vector3i position) {
        ...
        return switch (this.state.ordinal()) {
            ...
            case 2 -> this.arrayContents.array[SimplePixelBuffer.index(position)];
            default -> null;
        };
    }
    ...
    public void setPixelContent(@Nonnull Vector3i position, @Nullable T value) {
        ...
        switch (this.state.ordinal()) {
            ...
            case 2: {
                this.arrayContents.array[SimplePixelBuffer.index((Vector3i)position)] = value;
                break;
            }
            default: {
    ...
    private static int index(@Nonnull Vector3i position) {
        return position.y + position.x * SimplePixelBuffer.SIZE.y + position.z * SimplePixelBuffer.SIZE.y * SimplePixelBuffer.SIZE.x;
    }
    ...
    implements MemInstrument {
        ...
        public ArrayContents() {
            this.array = new Object[PixelBuffer.SIZE.x * PixelBuffer.SIZE.y * PixelBuffer.SIZE.z];
        }
