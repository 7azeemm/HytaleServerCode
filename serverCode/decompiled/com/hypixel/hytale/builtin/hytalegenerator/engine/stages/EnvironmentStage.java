...
implements Stage {
    ...
    public void run(@Nonnull Stage.Context context) {
        ...
        PixelBufferView<Integer> biomeSpace = new PixelBufferView<Integer>(biomeAccess, biomeTypeClass);
        BufferBundle.Access.View environmentAccess = context.bufferAccess.get(this.environmentOutputBufferType);
        VoxelBufferView<Integer> environmentSpace = new VoxelBufferView<Integer>(environmentAccess, environmentClass);
