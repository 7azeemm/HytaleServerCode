...
public class VoxelBufferView<T>
implements VoxelSpace<T> {
    ...
    private VoxelBuffer<T> getBuffer_fromBufferGrid(int x_bufferGrid, int y_bufferGrid, int z_bufferGrid) {
        return (VoxelBuffer)this.bufferAccess.getBuffer(x_bufferGrid, y_bufferGrid, z_bufferGrid).buffer();
    }

    @Nonnull
    private VoxelBuffer<T> getBuffer_fromBufferGrid(@Nonnull Vector3i position_bufferGrid) {
        return (VoxelBuffer)this.bufferAccess.getBuffer(position_bufferGrid).buffer();
    }
}
