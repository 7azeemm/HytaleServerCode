...
public class PositionsPropDistribution
extends PropDistribution {
    ...
    public void distribute(@Nonnull PropDistribution.Context context) {
        ...
        this.rPositionProviderContext.pipe = (position, control) -> {
            assert (context.bounds.contains((Vector3d)position));
            context.pipe.accept((Vector3d)position, EmptyProp.INSTANCE, control);
        };
