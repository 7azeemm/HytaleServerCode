...
extends Prop {
    ...
    public boolean generate(@Nonnull Prop.Context context) {
        ...
        position.x = this.rIntersectingBounds.min.x;
        while (position.x < this.rIntersectingBounds.max.x) {
            position.z = this.rIntersectingBounds.min.z;
            while (position.z < this.rIntersectingBounds.max.z) {
                position.y = this.rIntersectingBounds.min.y;
                while (position.y < this.rIntersectingBounds.max.y) {
