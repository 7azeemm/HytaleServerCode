...
extends Prop {
    ...
    public ManualProp(@Nonnull List<Block> blocks) {
    ...
    public boolean generate(@Nonnull Prop.Context context) {
        ...
        for (Block block : this.blocks) {
            ...
            if (!bounds.contains(this.rPosition)) continue;
    ...
    public static class Block {
        ...
        @Nonnull
        public Block clone() {
            return new Block(this.material, this.position);
        }
    }
}
