...
public abstract class Prop {
    public abstract boolean generate(@Nonnull Context var1);
    ...
    public static class Context {
        ...
        public Context(@Nonnull Vector3i position, @Nonnull VoxelSpace<Material> materialReadSpace, @Nonnull VoxelSpace<Material> materialWriteSpace, @Nonnull EntityFunnel entityWriteBuffer, double distanceToBiomeEdge) {
