...
public abstract class Scanner {
    @Deprecated
    public abstract void scan(@Nonnull Context var1);
    ...
    public static class Context {
        ...
        public Context() {
            ...
            this.validPositions_out = new ArrayList<Vector3i>();
        }

        public Context(@Nonnull Vector3i position, @Nonnull Pattern pattern, @Nonnull VoxelSpace<Material> materialSpace, @Nonnull List<Vector3i> validPositions_out) {
