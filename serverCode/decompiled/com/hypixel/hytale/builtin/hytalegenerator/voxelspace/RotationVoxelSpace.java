...
public class RotationVoxelSpace
implements VoxelSpace<Material> {
    @Nonnull
    ...
    public RotationVoxelSpace(@Nonnull RotationTuple rotation_fromViewToSource, @Nonnull MaterialCache materialCache) {
        ...
        this.rotation_materialFromSourceToView = RotationTuple.of(rotation_fromViewToSource.yaw().toInverse(), rotation_fromViewToSource.pitch().toInverse(), rotation_fromViewToSource.roll().toInverse());
    ...
    public Material get(int x, int y, int z) {
        ...
        Material rotatedMaterial = this.materialCache.getMaterialRotated(material, this.rotation_materialFromSourceToView);
