...
public abstract class EntityHolderEventSystem<ECS_TYPE, EventType extends EcsEvent>
...
implements QuerySystem<ECS_TYPE> {
    ...
    public void handleInternal(@Nonnull Holder<ECS_TYPE> holder, @Nonnull Store<ECS_TYPE> store, @Nonnull CommandBuffer<ECS_TYPE> commandBuffer, @Nonnull EventType event) {
