...
implements NetworkSerializable<com.hypixel.hytale.protocol.ConditionalBlockSound> {
    public static final BuilderCodec<ConditionalBlockSound> CODEC = ((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)BuilderCodec.builder(ConditionalBlockSound.class, ConditionalBlockSound::new).append(new KeyedCodec<String>("SoundEventId", Codec.STRING), (cbs, s) -> {
        cbs.soundEventId = s;
    }, cbs -> cbs.soundEventId).addValidator(Validators.nonNull()).addValidator(SoundEvent.VALIDATOR_CACHE.getValidator()).addValidator(SoundEventValidators.MONO).addValidator(SoundEventValidators.LOOPING).add()).append(new KeyedCodec<String>("AmbienceFXId", Codec.STRING), (cbs, s) -> {
        cbs.ambienceFXId = s;
    }, cbs -> cbs.ambienceFXId).addValidator(Validators.nonNull()).addValidator(AmbienceFX.VALIDATOR_CACHE.getValidator()).add()).afterDecode(ConditionalBlockSound::processConfig)).build();
    ...
    public String toString() {
        return "ConditionalBlockSound{soundEventId='" + this.soundEventId + "', soundEventIndex=" + this.soundEventIndex + ", ambienceFXId='" + this.ambienceFXId + "', ambienceFXIndex=" + this.ambienceFXIndex + "}";
    }
}
