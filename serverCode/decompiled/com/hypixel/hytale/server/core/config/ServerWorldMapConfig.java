...
import com.hypixel.hytale.server.core.config.WorldMapConfig;
import javax.annotation.Nonnull;
import javax.annotation.Nullable;

public final class ServerWorldMapConfig
extends WorldMapConfig {
    @Nonnull
    public static final Codec<ServerWorldMapConfig> CODEC = BuilderCodec.builder(ServerWorldMapConfig.class, ServerWorldMapConfig::new, WorldMapConfig.ABSTRACT_CODEC).build();
    @Nullable
