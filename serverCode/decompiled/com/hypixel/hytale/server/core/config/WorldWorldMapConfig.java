...
public final class WorldWorldMapConfig
extends WorldMapConfig {
    ...
    @Nonnull
    public static final Codec<WorldWorldMapConfig> CODEC = BuilderCodec.builder(WorldWorldMapConfig.class, WorldWorldMapConfig::new, WorldMapConfig.ABSTRACT_CODEC).build();
