...
public class RemovedPlayerFromWorldEvent
implements IEvent<String> {
    ...
    public String toString() {
        return "RemovePlayerFromWorldEvent{, world=" + String.valueOf(this.world) + ", broadcastLeaveMessage=" + this.broadcastLeaveMessage + ", leaveMessage=" + String.valueOf(this.leaveMessage) + "} " + super.toString();
    }
}
