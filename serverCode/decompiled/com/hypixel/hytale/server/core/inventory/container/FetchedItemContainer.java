...
public class FetchedItemContainer
extends ItemContainer {
    ...
    @Override
    public EventRegistration<Void, ItemContainer.ItemContainerChangeEvent> registerChangeEvent(@Nonnull Consumer<ItemContainer.ItemContainerChangeEvent> consumer) {
        return this.fetcher.get().registerChangeEvent(consumer);
    }

    @Override
    public EventRegistration<Void, ItemContainer.ItemContainerChangeEvent> registerChangeEvent(@Nonnull EventPriority priority, @Nonnull Consumer<ItemContainer.ItemContainerChangeEvent> consumer) {
