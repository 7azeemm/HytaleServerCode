...
public class ItemContainerSystems {
    ...
    public static class OnReplacedHolder
    extends EntityHolderEventSystem<ChunkStore, BlockReplaceEvent> {
        ...
        @Override
        public void handle(@Nonnull Holder<ChunkStore> holder, @Nonnull Store<ChunkStore> store, @Nonnull CommandBuffer<ChunkStore> commandBuffer, @Nonnull BlockReplaceEvent event) {
    ...
    public static class OnReplaced
    extends EntityEventSystem<ChunkStore, BlockReplaceEvent> {
        ...
        @Override
        public void handle(int index, @Nonnull ArchetypeChunk<ChunkStore> archetypeChunk, @Nonnull Store<ChunkStore> store, @Nonnull CommandBuffer<ChunkStore> commandBuffer, @Nonnull BlockReplaceEvent event) {
            ItemContainerBlock otherContainer = event.getNewEntity().getComponent(this.itemContainerBlockComponentType);
            if (otherContainer == null) {
                return;
            }
    ...
    public static class OnAddedOrRemoved
    extends RefSystem<ChunkStore> {
        ...
        public void onEntityAdded(@Nonnull Ref<ChunkStore> ref, @Nonnull AddReason reason, @Nonnull Store<ChunkStore> store, @Nonnull CommandBuffer<ChunkStore> commandBuffer) {
            ...
            if (!remainder.isEmpty()) {
                ...
                Vector3d blockPosition = new Vector3d(ChunkUtil.worldCoordFromLocalCoord(blockChunkComponent.getX(), x), y, ChunkUtil.worldCoordFromLocalCoord(blockChunkComponent.getZ(), z));
        ...
        public void onEntityRemove(@Nonnull Ref<ChunkStore> ref, @Nonnull RemoveReason reason, @Nonnull Store<ChunkStore> store, @Nonnull CommandBuffer<ChunkStore> commandBuffer) {
            ...
            Holder[] itemEntityHolders = ItemComponent.generateItemDrops(entityStore, allItemStacks, dropPosition = blockPosition.add(0.5, 0.0, 0.5), Vector3f.ZERO);
