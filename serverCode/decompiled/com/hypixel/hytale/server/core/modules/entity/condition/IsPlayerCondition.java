...
extends Condition {
    @Nonnull
    public static final BuilderCodec<IsPlayerCondition> CODEC = BuilderCodec.builder(IsPlayerCondition.class, IsPlayerCondition::new, Condition.BASE_CODEC).build();
