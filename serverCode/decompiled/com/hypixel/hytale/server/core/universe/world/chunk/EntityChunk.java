...
implements Component<ChunkStore> {
    ...
    public static final BuilderCodec<EntityChunk> CODEC = ((BuilderCodec.Builder)BuilderCodec.builder(EntityChunk.class, EntityChunk::new).addField(new KeyedCodec<T[]>("Entities", new ArrayCodec<Holder<EntityStore>>(new StoredCodec<Holder<EntityStore>>(EntityStore.HOLDER_CODEC_KEY), Holder[]::new)), (entityChunk, array) -> {
        ...
        for (Ref ref : entityChunk.entityReferences) {
            Store store = ref.getStore();
            if (!store.getArchetype(ref).hasSerializableComponents(store.getRegistry().getData())) continue;
            array[index++] = store.copyEntity(ref);
        }
    ...
    public EntityChunk() {
        ...
        this.entityReferences = new ReferenceOpenHashSet<Ref<EntityStore>>();
    ...
    public Component<ChunkStore> clone() {
        ...
        return new EntityChunk(entityHoldersClone, new ReferenceOpenHashSet<Ref<EntityStore>>());
    }
