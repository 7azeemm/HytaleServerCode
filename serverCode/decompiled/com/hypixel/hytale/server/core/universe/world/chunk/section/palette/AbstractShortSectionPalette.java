...
implements ISectionPalette {
    ...
    public AbstractShortSectionPalette(@Nonnull short[] blocks, @Nonnull int[] data, @Nonnull Int2ShortMap externalIdCounts) {
        this(new Int2ShortOpenHashMap(externalIdCounts.size()), new Short2IntOpenHashMap(externalIdCounts.size()), new BitSet(externalIdCounts.size()), new Short2ShortOpenHashMap(externalIdCounts.size()), blocks);
        ...
        while (externalIdCountIter.hasNext()) {
            ...
            internalIdCounter = (short)(internalIdCounter + 1);
        }
        int index = 0;
