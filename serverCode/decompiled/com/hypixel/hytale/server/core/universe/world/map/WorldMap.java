...
implements NetworkSerializable<UpdateWorldMap> {
    ...
    public void addPointOfInterest(String id, String name, String markerType, @Nonnull Transform transform) {
        MapMarker old = this.pointsOfInterest.putIfAbsent(id, new MapMarker(id, Message.translation(name).getFormattedMessage(), markerType, PositionUtil.toTransformPacket(transform), null, null));
        if (old != null) {
