...
public class Steering {
    ...
    public boolean equals(@Nullable Object o) {
        ...
        if (this.hasTranslation != steering.hasTranslation) {
            return false;
        }
        if (Float.compare(steering.yaw, this.yaw) != 0) {
            return false;
        }
        if (this.hasYaw != steering.hasYaw) {
            return false;
        }
        if (Float.compare(steering.pitch, this.pitch) != 0) {
            return false;
        }
        if (this.hasPitch != steering.hasPitch) {
            return false;
        }
        if (Float.compare(steering.roll, this.roll) != 0) {
            return false;
        }
        if (this.hasRoll != steering.hasRoll) {
            return false;
        }
        ...
        if (this.hasRelativeTurnSpeed != steering.hasRelativeTurnSpeed) {
            return false;
        }
        return this.maxDistanceComponentSelector.equals(steering.maxDistanceComponentSelector);
    }
