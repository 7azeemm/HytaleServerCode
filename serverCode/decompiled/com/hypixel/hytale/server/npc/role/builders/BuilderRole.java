...
implements SpawnEffect {
    ...
    public BuilderRole readConfig(@Nonnull JsonElement data) {
        ...
        this.getBoolean(data, "AvoidanceFallCheck", this.avoidanceFallCheck, false, BuilderDescriptorState.Experimental, "Perform extra avoidance fall check", null);
        ...
        this.getEnum(data, "AvoidanceMode", this.avoidanceMode, Role.AvoidanceMode.class, Role.AvoidanceMode.Any, BuilderDescriptorState.Experimental, "Abilities to use for avoidance", null);
        this.getEnum(data, "SeparationMode", this.separationMode, Role.SeparationMode.class, Role.SeparationMode.Legacy, BuilderDescriptorState.Experimental, "Mode for separation calculation", null);
        this.getDouble(data, "SeparationPushSafeDistanceMultiplier", this.separationSafeDistanceMultiplier, 0.8, (DoubleValidator)DoubleRangeValidator.between01(), BuilderDescriptorState.Experimental, "Push Mode: Multiplier to reduce target distance to avoid NPC jittering close to target", null);
        this.getDouble(data, "SeparationLegacySteeringStrength", this.separationLegacySteeringStrength, 0.5, (DoubleValidator)DoubleSingleValidator.greater0(), BuilderDescriptorState.Experimental, "Legacy mode: Separation steering strength", null);
        this.getDouble(data, "SeparationPushSteeringStrength", this.separationPushSteeringStrength, 0.8, (DoubleValidator)DoubleSingleValidator.greater0(), BuilderDescriptorState.Experimental, "Push mode: Separation steering strength", null);
        this.getDouble(data, "SeparationPushDistanceWeightDefault", this.separationPushDistanceWeightDefault, 1.0, (DoubleValidator)DoubleSingleValidator.greater0(), BuilderDescriptorState.Experimental, "Push mode: falloff exponent for separation distance", null);
        this.getDouble(data, "SeparationPushDistanceWeightTarget", this.separationPushDistanceWeightTarget, 8.0, (DoubleValidator)DoubleSingleValidator.greater0(), BuilderDescriptorState.Experimental, "Push mode: falloff exponent when NPC is close to motion target", null);
        this.getDouble(data, "SeparationPushDistanceWeightAttacker", this.separationPushDistanceWeightAttacker, 8.0, (DoubleValidator)DoubleSingleValidator.greater0(), BuilderDescriptorState.Experimental, "Push mode: falloff exponent towards other potential attackers when close to motion target", null);
        this.getDouble(data, "SeparationPushSpeedScale", this.separationPushSpeedScale, 0.5, (DoubleValidator)DoubleRangeValidator.fromExclToIncl(0.0, 1.0), BuilderDescriptorState.Experimental, "Push mode: scale to increase smaller speeds for separation", null);
        this.getOverride(data, "SeparationOverrideOrientation", this.featureOverrideOrientationHint, BuilderDescriptorState.Experimental, "Whether to override orientation of NPC when separating", null);
        this.getOverride(data, "SeparationOverrideAlwaysSeparate", this.featureOverrideAlwaysSeparate, BuilderDescriptorState.Experimental, "Whether to separate even if the NPC would rest", null);
        this.getOverride(data, "SeparationOverrideNormalizeDistances", this.featureOverrideNormalizeDistances, BuilderDescriptorState.Experimental, "Whether to normalize distances when summing distances", null);
        ...
        this.getDouble(data, "DeathAnimationTime", this.deathAnimationTime, 1.5, (DoubleValidator)DoubleSingleValidator.greaterEqual0(), BuilderDescriptorState.Experimental, "How long to let the death animation play before removing", null);
        this.getAsset(data, "DeathParticles", this.deathParticles, "Effect_Death", (AssetValidator)ParticleSystemExistsValidator.withConfig(AssetValidator.CanBeEmpty), BuilderDescriptorState.Stable, "Particles to play when the NPC corpse is removed.", null);
        this.getBoolean(data, "DropDeathItemsInstantly", this.dropDeathItemsInstantly, false, BuilderDescriptorState.Stable, "Whether or not to drop death items instantly on death, or when the body disappears.", null);
        ...
        this.getAsset(data, "SpawnParticles", this.spawnParticles, null, (AssetValidator)ParticleSystemExistsValidator.withConfig(AssetValidator.CanBeEmpty), BuilderDescriptorState.Experimental, "Particle system when spawning", null);
        this.getVector3d(data, "SpawnParticlesOffset", this.spawnParticleOffset, null, null, BuilderDescriptorState.Experimental, "Displacement from foot point to spawn relative to NPC heading", null);
        this.getString(data, "SpawnParticlesTargetNode", this.spawnParticlesTargetNode, null, null, BuilderDescriptorState.Stable, "Target node for spawn particles", null);
        this.getBoolean(data, "SpawnParticlesDetached", this.spawnParticlesDetached, true, BuilderDescriptorState.Stable, "Whether spawn particles should be attached to the model or not", null);
    ...
    public Vector3d getSpawnParticleOffset(@Nonnull BuilderSupport support) {
        return BuilderRole.createVector3d(this.spawnParticleOffset.get(support.getExecutionContext()), Vector3d.ZERO::clone);
    }
