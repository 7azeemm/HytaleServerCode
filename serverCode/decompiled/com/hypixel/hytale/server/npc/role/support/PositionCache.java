...
public class PositionCache {
    ...
    private final List<Ref<EntityStore>> droppedItems = new ReferenceArrayList<Ref<EntityStore>>();
    private final List<Ref<EntityStore>> spawnMarkers = new ReferenceArrayList<Ref<EntityStore>>();
    private final List<Ref<EntityStore>> spawnBeacons = new ReferenceArrayList<Ref<EntityStore>>();
    private final Reference2ByteMap<Ref<EntityStore>> lineOfSightCache = new Reference2ByteOpenHashMap<Ref<EntityStore>>();
    private final Reference2ByteMap<Ref<EntityStore>> inverseLineOfSightCache = new Reference2ByteOpenHashMap<Ref<EntityStore>>();
    private final Reference2ByteMap<Ref<EntityStore>> friendlyFireCache = new Reference2ByteOpenHashMap<Ref<EntityStore>>();
