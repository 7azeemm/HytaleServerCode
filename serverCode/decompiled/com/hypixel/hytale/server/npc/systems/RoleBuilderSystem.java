...
extends HolderSystem<EntityStore> {
    ...
    public RoleBuilderSystem() {
        ...
        this.dependencies = Set.of(new SystemDependency(Order.AFTER, EntityStatsSystems.Setup.class), new SystemDependency(Order.AFTER, PhysicsValuesAddSystem.class), new SystemDependency(Order.AFTER, NPCSystems.OnNPCAdded.class), new SystemDependency(Order.BEFORE, ModelSystems.ModelSpawned.class));
