...
public class SpawnReferenceSystems {
    ...
    extends EntityTickingSystem<EntityStore> {
        @Nonnull
        private static final Set<Dependency<EntityStore>> DEPENDENCIES = Set.of(new SystemDependency(Order.AFTER, NPCPreTickSystem.class), new SystemDependency(Order.BEFORE, DeathSystems.CorpseRemoval.class));
        @Nonnull
        ...
        public void onEntityAdded(@Nonnull Ref<EntityStore> ref, @Nonnull AddReason reason, @Nonnull Store<EntityStore> store, @Nonnull CommandBuffer<EntityStore> commandBuffer) {
            switch (reason) {
                ...
                case LOAD: {
                    ...
                    context.log("%s synced up with marker %s", (Object)npcComponent.getRoleName(), (Object)uuid);
                }
            }
        }
